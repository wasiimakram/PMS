	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo base_url() ?>Admin/users"><em class="fa fa-users">&nbsp;</em> Users</a></li>
			
            <li><a href="<?php echo base_url() ?>Admin/medicine"><em class="fa fa-medkit">&nbsp;</em> Medicines</a></li>
			
            <li><a href="<?php echo base_url() ?>Admin/total_sales">
            <em class="fa fa-shopping-cart">&nbsp;</em>  Total Sales</a>
            </li>
